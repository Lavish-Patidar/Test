...
export default function Profile() {
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/user/users/${currentUser._id}`, {
        method: 'DELETE',
      });
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 mt-12">
          ...
          <div className="flex justify-between mt-8">
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-md text-white ${currentIndex <= 0
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-md text-white ${currentIndex >= steps.length - 1
